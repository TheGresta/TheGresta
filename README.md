...
<div align="center">
  <table>
    ...
    <tr>
      <td>⚙️</td><td>Backend, <b>.NET 10</b> &amp; distributed systems</td>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/TheGresta/DotNet.Architect.Playbook">📘 DotNet.Architect.Playbook</a></h3>
      Enterprise .NET patterns as isolated, runnable chapters — polyglot persistence,
      MassTransit sagas, CQRS, OAuth2/OIDC, RAG with Semantic Kernel and
      OpenTelemetry-backed observability.
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/TheGresta/platform-shared-kernel">🧱 platform-shared-kernel</a></h3>
      The reusable kernel my services sit on — primitives, result and error types, and
      persistence/messaging abstractions, so cross-cutting concerns get solved once.
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/TheGresta/Kodlama.io-devs">🏛️ Kodlama.io-devs</a></h3>
      A modular monolith on Clean Architecture — layered boundaries, CQRS and
      cross-cutting pipeline behaviours.
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/TheGresta/MailingMicroservice">📬 MailingMicroservice</a></h3>
      A standalone mailing service consuming a RabbitMQ queue via MailKit.
    </td>
  </tr>
</table>
</div>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/TheGresta/TheGresta/output/streak-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/TheGresta/TheGresta/output/streak-light.svg" />
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/TheGresta/TheGresta/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/TheGresta/TheGresta/output/github-contribution-grid-snake.svg" />
  <img alt="Contribution grid snake animation" src="https://raw.githubusercontent.com/TheGresta/TheGresta/output/github-contribution-grid-snake.svg" />
</picture>
